public class BgItem
{
	...
	public static bool isExistKeyNews(string keyNew)
	{
		...
		while (true)
		{
			if (num < vKeysNew.size())
			{
				if (((string)vKeysNew.elementAt(num)).Equals(keyNew))
					break;
				num++;
				continue;
			}
	...
	public static bool isExistKeyLast(string keyLast)
	{
		...
		while (true)
		{
			if (num < vKeysLast.size())
			{
				if (((string)vKeysLast.elementAt(num)).Equals(keyLast))
					break;
				num++;
				continue;
			}
	...
	public bool isNotBlend()
	{
		...
		while (true)
		{
			if (num < idNotBlend.Length)
			{
				if (idImage == idNotBlend[num])
					break;
				num++;
				continue;
			}
	...
	public bool isMiniBg()
	{
		...
		while (true)
		{
			if (num < isMiniBgz.Length)
			{
				if (idImage == isMiniBgz[num])
					break;
				num++;
				continue;
			}
