...
public class mGraphics
{
	...
	public static Hashtable cachedTextures;
	...
	{
		if (image != null && (!MainMod.isReduceGraphics || image.Equals(MainMod.logoServerListScreen) || image.Equals(MainMod.logoGameScr) || image.Equals(GameScr.imgCapcha)))
