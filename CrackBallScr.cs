...
public class CrackBallScr : mScreen
{
	...
	public override void paint(mGraphics g)
	{
		try
		{
			...
			mFont.tahoma_7_yellow.drawString(g, Char.myCharz().xu + string.Empty, num3 + 24, 2, mFont.LEFT, mFont.tahoma_7_grey);
			mFont.tahoma_7_yellow.drawString(g, Char.myCharz().luong + string.Empty, num3 + 100, 2, mFont.LEFT, mFont.tahoma_7_grey);
			g.drawImage(Panel.imgLuongKhoa, num3 + 150, 8, 3);
			mFont.tahoma_7_yellow.drawString(g, Char.myCharz().luongKhoa + string.Empty, num3 + 160, 2, mFont.LEFT, mFont.tahoma_7_grey);
